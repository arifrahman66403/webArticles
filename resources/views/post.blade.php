<x-layout>
  ...
  <div x-data="{ open: false }">
    ...
    <div class="flex justify-end">
      <button @click="open = true" 
        class="rounded-md bg-indigo-500 hover:bg-indigo-700 text-white font-bold text-xs py-0.5 px-1 md:py-2 md:px-4 md:text-md transition">
        Show Another
      </button>
    </div>
  ...
  <main class="pt-2 pb-4 lg:pt-4 lg:pb-8 dark:bg-gray-900 antialiased">
    <div class="flex justify-between px-4 mx-auto max-w-screen-xl">
      <article class="mx-auto w-full max-w-4xl bg-white rounded-lg shadow-md p-6 format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
          ...
          <address class="flex items-center mb-6 not-italic">
            <div class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
              <a href="/about/{{ $post->author->username }}" 
                class="hover:ring-2 hover:ring-indigo-500 rounded-full mr-4">
...
<div 
  ...
  @flash-message.window="
      ...
      console.log('Flash Event:', $event.detail);
  "
  x-show="show"
  x-transition
