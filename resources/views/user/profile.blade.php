    ...
    <div class="max-w-4xl mx-auto py-8">
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div class="bg-gray-800 p-6 flex flex-col items-center text-white relative">
                ...
                <!-- Nama & Username -->
                <h1 class="mt-5 text-3xl font-bold">{{ Auth::user()->name }}</h1>
                <p class="text-indigo-200 text-sm tracking-wide"><b>@</b>{{ Auth::user()->username }}</p>
            </div>
            ...
            <div class="p-6 border-t bg-gray-50 flex justify-end">
                ...
                <a href="{{ route('user.setting') }}" 
                   class="ml-4 px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700">
                   Edit Profile
                </a>
            </div>
        </div>
